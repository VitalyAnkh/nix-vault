  ...
  config = mkMerge [
    (mkIf cfgWayland.enable {
      ...
      services = {
        ...
        #  settings = {
        #    default_session = {
        #      # Wayland Desktop Manager is installed only for the primary user via home-manager!
        #      user = myvars.username;
        #      # .wayland-session is a script generated by home-manager, which links to the current wayland compositor (sway or others).
      ...
      # needed for swaylock under some desktop/login-manager combinations
